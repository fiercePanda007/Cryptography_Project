...
std::string SHA512::gethex(std::string bin) {
...
std::string SHA512::decimaltohex(int64 deci) {
    std::string EQBIN = std::bitset<64>(deci).to_string();
...
int64 SHA512::BintoDec(std::string bin) {
    int64 value = std::bitset<64>(bin).to_ullong();
    return value;
}

int64 SHA512::rotate_right(int64 x, int n) {
    return (x >> n) | (x << (64 - n));
}

int64 SHA512::shift_right(int64 x, int n) {
    return (x >> n);
}

void SHA512::separator(std::string getBlock) {
    int chunknum = 0;
...
int64 SHA512::maj(int64 a, int64 b, int64 c) {
    return (a & b) ^ (b & c) ^ (c & a);
}

int64 SHA512::Ch(int64 e, int64 f, int64 g) {
    return (e & f) ^ (~e & g);
}

int64 SHA512::sigmaE(int64 e) {
    return rotate_right(e, 14) ^ rotate_right(e, 18) ^ rotate_right(e, 41);
}

int64 SHA512::sigmaA(int64 a) {
    return rotate_right(a, 28) ^ rotate_right(a, 34) ^ rotate_right(a, 39);
}

void SHA512::Func(int64 a, int64 b, int64 c, int64& d, int64 e, int64 f, int64 g, int64& h, int K) {
...
std::string SHA512::generateSHA512(std::string myString) {
    ...
    std::string s1024 = fixedstream.str();
    ...
    std::string lengthbits = std::bitset<128>(orilen).to_string();
    s1024 += lengthbits;
    int blocksnumber = s1024.length() / 1024;
    int chunknum = 0;
    std::string Blocks[blocksnumber];
